...
export const TRAINERS: Trainer[] = [
  { id: "anisha", name: "Anisha Shah", photo: photo("001-1_Anisha-1-e1590837044475.jpg"), specialty: "Mat · Strength", tier: 1, active: true, certs: certs(["barre", "mat", "cycle", "strength", "fit", "cardio", "amped", "bbb", "hiit"]), access: { kwality: loc([0, 1, 2], [5, 6], 4, 7.7), supreme: loc([3, 4], [5, 6], 4, 6.1) } },
  { id: "atulan", name: "Atulan Purohit", photo: photo("002-Atulan-Image-1.jpg"), specialty: "Strength · Barre", tier: 1, active: true, certs: certs(["barre", "mat", "strength", "fit", "cardio", "amped", "bbb", "recovery", "hiit"]), access: { kwality: loc([0, 2, 3, 4, 5, 6], [1], 4, 5.9), supreme: loc([0, 2, 3, 4, 5, 6], [1], 4, 5.2) } },
  { id: "cauveri", name: "Cauveri Vikrant", photo: photo("003-Cauveri-1.jpg"), specialty: "Barre · Cycle", tier: 1, active: true, certs: certs(["barre", "mat", "cycle", "cardio", "bbb", "recovery", "fit"]), access: { kwality: loc([1, 2, 4, 5, 6], [0, 3], 3, 5.7), supreme: loc([1, 5, 6], [0, 3], 3, 5.4) } },
  ...
  { id: "karan", name: "Karan Bhatia", photo: photo("005-Karan-Bhatia-1-1.jpeg"), specialty: "Barre", tier: 2, active: true, certs: certs(["barre", "cardio", "recovery", "hiit", "cycle", "bbb"]), access: { kwality: loc([5, 6], [0, 1, 2], 2, 3.4), kenkere: loc([1, 4, 5, 6], [0], 2, 3.6) } },
  { id: "mrigakshi", name: "Mrigakshi Jaiswal", photo: photo("007-Mrigakshi-Image-2.jpg"), specialty: "FIT · Cardio", tier: 1, active: true, certs: certs(["barre", "mat", "fit", "cardio", "strength", "hiit", "bbb", "cycle", "recovery"]), access: { kwality: loc([1, 2, 3, 4, 5, 6], [0], 4, 6.6), supreme: loc([1, 4], [0], 3, 5.9) } },
  { id: "pranjali", name: "Pranjali Jain", photo: photo("008-Pranjali-Image-1.jpg"), specialty: "Barre", tier: 1, active: true, certs: certs(["barre", "mat", "cardio", "amped", "strength", "recovery", "bbb", "hiit", "fit"]), access: { kwality: loc([0, 1, 2, 4, 5, 6], [3], 3, 5.4), kenkere: loc([0, 2, 5, 6], [3], 3, 5.1) } },
  { id: "pushyank", name: "Pushyank Nahar", photo: photo("009-Pushyank-Nahar-1.jpeg"), specialty: "Barre", tier: 1, active: true, certs: certs(["barre", "mat", "cardio", "recovery", "bbb", "fit", "strength"]), access: { kenkere: loc([0, 1, 2, 3, 4, 5], [6], 4, 5.3), copper: loc([5, 6], [2], 2, 4.8) } },
  { id: "reshma", name: "Reshma Sharma", photo: photo("010-Reshma-Image-3.jpg"), specialty: "FIT · Conditioning", tier: 1, active: true, certs: certs(["barre", "mat", "fit", "cardio", "strength", "amped", "recovery", "hiit", "cycle", "bbb"]), access: { kwality: loc([0, 1, 2, 4, 5, 6], [3], 4, 6.4), supreme: loc([0, 5, 6], [3], 3, 5.8) } },

...
export const TRAINERS: Trainer[] = [
  ...
  { id: "cauveri", name: "Cauveri Vikrant", photo: photo("003-Cauveri-1.jpg"), specialty: "Barre · Cycle", tier: 1, active: true, certs: certs(["barre", "mat", "cycle", "cardio"]), access: { kwality: loc([1, 2, 4, 5, 6], [0, 3], 3, 5.7), supreme: loc([1, 5, 6], [0, 3], 3, 5.4) } },
  { id: "kajol", name: "Kajol Kanchan", photo: photo("004-Kajol-Kanchan-1.jpg"), specialty: "Barre · Mat", tier: 1, active: true, certs: certs(["barre", "mat", "cardio", "fit"]), access: { kenkere: loc([0, 1, 3, 4, 5, 6], [2], 4, 5.2), courtside: loc([0, 2, 4, 5, 6], [], 2, 4.6) } },
  { id: "karan", name: "Karan Bhatia", photo: photo("005-Karan-Bhatia-1-1.jpeg"), specialty: "Barre", tier: 2, active: true, certs: certs(["barre", "cardio"]), access: { kwality: loc([5, 6], [0, 1, 2], 2, 3.4), kenkere: loc([1, 4, 5, 6], [0], 2, 3.6) } },
  ...
  { id: "pranjali", name: "Pranjali Jain", photo: photo("008-Pranjali-Image-1.jpg"), specialty: "Barre", tier: 1, active: true, certs: certs(["barre", "mat", "cardio", "amped", "strength"]), access: { kwality: loc([0, 1, 2, 4, 5, 6], [3], 3, 5.4), kenkere: loc([0, 2, 5, 6], [3], 3, 5.1) } },
  ...
  { id: "reshma", name: "Reshma Sharma", photo: photo("010-Reshma-Image-3.jpg"), specialty: "FIT · Conditioning", tier: 1, active: true, certs: certs(["barre", "mat", "fit", "cardio", "strength"]), access: { kwality: loc([0, 1, 2, 4, 5, 6], [3], 4, 6.4), supreme: loc([0, 5, 6], [3], 3, 5.8) } },
  ...
  { id: "rohan", name: "Rohan Dahima", photo: photo("012-Rohan-Image-3.jpg"), specialty: "Cycle · Barre", tier: 1, active: true, certs: certs(["barre", "mat", "cycle", "fit", "cardio", "hiit"]), access: { kwality: loc([0, 1, 2, 3, 4, 5, 6], [1], 4, 6.8), supreme: loc([0, 2, 4, 5, 6], [1], 3, 6.2) } },
  { id: "saniya", name: "Saniya Dastoor", photo: photo("013-Saniya-Image-1.jpg"), specialty: "Barre · Mat", tier: 2, active: true, certs: certs(["barre", "mat", "cardio"]), access: { kenkere: loc([0, 2, 4, 5, 6], [1], 3, 4.9), copper: loc([5, 6], [3], 2, 4.6) } },
  { id: "shruti", name: "Shruti Kulkarni", photo: photo("014-Shruti-Kulkarni.jpeg"), specialty: "Mat · FIT", tier: 1, active: true, certs: certs(["barre", "mat", "fit"]), access: { kenkere: loc([0, 2, 3, 5, 6], [1, 4], 3, 5.0), copper: loc([0, 3, 5, 6], [1], 2, 4.7) } },
  ...
  { id: "karanvir", name: "Karanvir Bhatia", photo: photo("Karanvir.jpg"), specialty: "PowerCycle", tier: 1, active: true, certs: certs(["barre", "mat", "cycle", "cardio"]), access: { kwality: loc([0, 1, 2, 3, 5, 6], [4], 4, 6.0), supreme: loc([0, 1, 3, 5, 6], [4], 3, 6.3) } },
  ...
  { id: "simonelle", name: "Simonelle De Vitre", photo: photo("Simonelle.jpeg"), specialty: "Cycle · Mat", tier: 2, active: true, certs: certs(["cycle", "mat", "barre"]), access: { kwality: loc([3, 5, 6], [0, 1], 2, 5.1), supreme: loc([3, 5, 6], [0, 1], 2, 4.9) } },
  ...
  { id: "simran", name: "Simran Kapoor", photo: photo("Simran.jpeg"), specialty: "Barre", tier: 2, active: true, certs: certs(["barre", "mat", "fit"]), access: { kenkere: loc([1, 3, 5, 6], [0], 3, 4.8), courtside: loc([2, 4, 5, 6], [], 2, 4.4) } },
  { id: "veena", name: "Veena Nair", photo: photo("Veena.jpeg"), specialty: "Mat · Recovery", tier: 2, active: true, certs: certs(["mat", "recovery", "barre"]), access: { copper: loc([0, 2, 4, 5, 6], [1], 2, 4.5), kenkere: loc([5, 6], [2], 2, 4.3) } },
];
